...
# Assumes: in run-test folder, you have an inputs folder with individual folders per input
# Assumes: in run-test folder, you have the sbatch file: sbatch-gaussian.sh in progress-files folder
